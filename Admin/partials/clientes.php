        ...
        <div class="row">
            ...
            <div class="form-group" style="padding-right: 0px; padding-left: 16.5px;">
                ...
                <div class="col-12 no-padding">
                    ...
                    <select name="departamento" onchange="cambia();" style="width:204px;" class="form-control input-sm" id="departamento" placeholder="Ingrese el departamento" required="">
            ...
            <div class="form-group" style="padding-right: 0px; padding-left: 16.5px;">
                ...
                <div class="col-12 no-padding">
                    ...
                    <select class="form-control" name="provincia" style="width:204px;" id="provincia" onchange="cambiaDistrito();" placeholder="Ingrese la provincia" required="">
            ...
            <div class="form-group" style="padding-right: 0px; padding-left: 16.5px;">
                ...
                <div class="col-12 no-padding">
                    ...
                    <select class="form-control input-sm" name="distrito" style="width:204px;" id="distrito" placeholder="Ingrese el distrito" required=""><option>Seleccione el Distrito</option>
                    </select>
                </div>
            </div>
            <div class="form-group" style="padding-right: 0px; padding-left: 16.5px;">
