<?php
    ...
    require '../clases/clsCuotas.php';

    if($_POST['options'] == 'C'){
        $validar = clsCuotas::Validar(Conexion::getInstancia(), $_POST['tipo'], $_POST['idclient'], $_POST['cuotas'], $_POST['moras'],
         $_POST['monto'], $_POST['tasa'], $_POST['fecha_des']);

        if($validar == true){
            echo json_encode(array('success' => 2));
        }else{
            $registro = clsCuotas::Registro(Conexion::getInstancia(), $_POST['tipo'], $_POST['idclient'], $_POST['cuotas'], $_POST['moras'],
            $_POST['monto'], $_POST['tasa'], $_POST['fecha_des']);
            if($registro > 0){
