...
if(isset($_POST['consulta'])){
    ...
    $query=$conexion->prepare("SELECT clientes.id_cliente, clientes.nombre, clientes.apellido, clientes.extranjero, clientes.ruc, clientes.direccion, clientes.distrito, clientes.provincia,
    clientes.departamento, clientes.celular, clientes.telefono FROM clientes
    WHERE extranjero LIKE '%".$q."%'");
    ...
    if( $query->rowCount() > 0){
                    ...
                    <div class='form-group' style='padding-right: 0px; padding-left: 16.5px;'>
                        <label class='col-12 control-label no-padding' for='dniruc'>Extranjero</label>
                        <div class='col-12 no-padding'>
                            <input disabled type='text' class='form-control input-sm' name='dniruc'  placeholder=''value='".$fila['extranjero']."'>
                ...
                <div class='row' id='validarcliente'>
                    ...
                    <div class='form-group' style='padding-right: 0px; padding-left: 16.5px;'>
                        ...
                        <div class='col-12 no-padding'>
                            ...
                            <select class='form-control input-sm' name='distrito' style='width:204px;' placeholder='Ingrese el distrito' ><option>Seleccione el Distrito</option>
                            </select>
                        </div>
                    </div>
                    <div class='form-group' style='padding-right: 0px; padding-left: 16.5px;'>
